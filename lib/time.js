...
function getUMPtime() {
    ...
    var month = appendPrefix(t.getMonth() + 1, 2);
    var date = appendPrefix(t.getDate(), 2);
    var hour = appendPrefix(t.getHours(), 2);
    var minutes = appendPrefix(t.getMinutes(), 2);
    var second = appendPrefix(t.getSeconds(), 2);
    var millSecond = appendPrefix(t.getMilliseconds(), 3);
